...
from flufl.bounce._bouncers.caiwireless import Caiwireless
from flufl.bounce._bouncers.microsoft import Microsoft
from flufl.bounce._bouncers.smtp32 import SMTP32
...
class BounceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        """See `unittest.TestCase`."""
        module_name = 'flufl.bounce._bouncers.' + self.bounce_module
...
class OtherBounceTests(unittest.TestCase):
    def test_SMTP32_failure(self):
        ...
        with closing(resource_stream('flufl._bouncers.tests.data',
